...
type Props = {};
export class ListTraining extends React.Component<Props, State> {
  constructor(props) {
    super(props);
    this.state = {};
  }
    ...
    return (
      ...
      >
        <Header as="h2">
          ...
          <Header.Content>
            รายการตรวจสอบรายงาน Training
            <Header.Subheader>รายงานสถานะการตรวจสอบรายงาน Training</Header.Subheader>
          </Header.Content>
        </Header>
        <hr />
        <br />
